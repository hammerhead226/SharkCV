...
parser.add_argument('-ii', metavar='file', dest='input_image', help='input image')
parser.add_argument('-iv', metavar='N', dest='input_video', help='input video/webcam (default: -1)', default=-1)
